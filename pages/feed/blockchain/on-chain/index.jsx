      ...
      <Layout>
        <div className=" mx-auto mb-8 mt-8 text-center relative z-0 max-w-3xl">
          ...
          <p className="text-base text-gray-500 font-light mb-2">
            ...
            paylaşmalarını sağlayan merkezi olmayan bir sosyal medya
            platformudur. Kullanıcıların düşünce ve fikirlerini dünya ile
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center w-full">
                    <div className="flex flex-col  mt-4 w-full">
                      <Link href={`/on-chain/${data[0].slug}`}>
                        <h2
...
export async function getServerSideProps(context) {
  ...
  const {data} = await axios.get(`/api/onchain`, {
    headers: {
      cookie: cookie,
    },
  });
