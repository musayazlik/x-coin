    ...
    <Layout>
      <div className="max-w-xl mx-auto mb-14  mt-8 text-center relative z-0">
        <h1 className="text-4xl font-semibold mb-6 lg:text-5xl text-rose-600">
          <span className="text-indigo-600">Alt Coinler</span>
        </h1>
        <p className="text-xl text-gray-500 font-medium mb-2">
          Bu sayfada alt coinler ile ilgili bilgiler alabilirsiniz.
        </p>
      </div>
                ...
                return (
                  ...
                  >
                    <th scope="row" className="text-left">
                      <h3
                        className="py-3 px-2 whitespace-nowrap text-sm font-medium">
                        {item.name}
                      </h3>
                    </th>
                    <th scope="row" className="text-left">
