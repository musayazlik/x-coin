    ...
    <Layout>
      <div className="max-w-xl mx-auto mb-14  mt-8 text-center relative z-0">
        <h1
          ...
          <span className="text-indigo-600">Aluminum</span>
        </h1>
        <p className="text-base sm:text-lg text-gray-500 font-normal mb-2">
          Bu sayfada Aluminum ile ilgili bilgiler alabilirsiniz..
        </p>
      </div>
...
export default memo(AluminumPage);
