  ...
  const blogDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`/api/dashboard/onchain?id=${id}`)
          .then((res) => {
            Swal.fire({
              icon: "success",
              title: "Başarılı",
        ...
        <div className="flex justify-between items-center px-4">
          <div className="flex flex-col justify-center">
            ...
            <p className="sm:text-sm text-gray-400">
              On Chain içeriklerini buradan yönetebilirsiniz.
            </p>
          </div>

          <button
            onClick={() => {
              router.push(`/dashboard/on-chain/add`);
            }}
                          ...
                          <tr key={item._id} className="bg-zinc-700 border-b">
                            ...
                            <td
                              ...
                              <div
                                ...
                                <Link
                                  href={`/dashboard/on-chain/edit/${item._id}`}
