                          ...
                          <tr key={item._id} className="bg-zinc-700 border-b">
                            ...
                            <td
                              ...
                              {item.memberShipType === "free" && (
                                <span
                                  className="bg-zinc-600 text-zinc-800 px-2 py-1 rounded-md">
                                    Ücretsiz
                                  </span>
                              )}
                              ...
                              {item.memberShipType === "standard" && (
                                <span
                                  className="bg-slate-600 text-slate-800 px-2 py-1 rounded-md">
                                    Standart
                                  </span>
                              )}
                              ...
                              {item.memberShipType === "premium" && (
                                <span
                                  className="bg-yellow-600 text-yellow-800 px-2 py-1 rounded-md">
                                    Premium
                                  </span>
                              )}
                            </td>
...
export async function getServerSideProps(context) {
  ...
  const {data} = await axios.get(
    `/api/dashboard/membership-sales`,
    {
      headers: {
        cookie: cookie,
      },
