...
const EducationDetail = ({
  ...
  return (
    <>
      ...
      <Layout>
        <div
          className=" flex flex-col-reverse xl:flex-row mb-12 items-start gap-8  ">
          <div className="w-full  xl:w-3/12">
            <h2
              className="text-white text-xl  xl:text-2xl font-bold mb-4 border-l-4 hover:border-l-8 duration-300 border-rose-700 px-4 bg-zinc-900 py-3 rounded"
            >
              {t.popularEducations}
            </h2>
            <div
              className="flex flex-row xl:flex-col overflow-auto py-3 gap-3 px-3 ">
              {
                    ...
                    <CardBody
                      ...
                      <div
                        ...
                        <Link
                          ...
                          />
                          <span
                            className={"whitespace-nowrap"}>{t.readmore}</span>
                        </Link>
                      </div>

                      <div
                        className="price flex justify-around w-full items-center">
          ...
          <div className="w-full  xl:w-9/12">
            <div>
              <Image src={data.image} alt={data.title} quality={100}
                     width={1200}
              ...
              <div
                ...
                <div className="flex justify-center gap-4 items-center">
                  ...
                  <span
                    className={"text-sm font-bold flex" +
                      " text-rose-600" +
                      " items-center  "}> {t.instructor} </span>
                    <h3
                      className="text-sm font-medium leading-4">
                      {data.instructor}
                    </h3>
              ...
              {data.video === "" ? (
                ...
                <div className="aspect-w-16 aspect-h-9">
                  <div className="buy">
                    <div className=" mb-4">
                      <p
                        className="text-gray-200">{t.basket.price} : {data.price} tl</p>
                    </div>
                    <a
...
export async function getServerSideProps() {
  ...
  const {data} = await axios.get(`${process.env.APP_URL}/api/popularEducation?limit=3`);
