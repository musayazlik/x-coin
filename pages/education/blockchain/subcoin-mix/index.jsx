                          ...
                          >
                            ...
                            <CardBody
                              ...
                              <div className="flex flex-col">
                                ...
                                <Link href={
                                  `/analysis/education/subcoin-mix/${item.slug}`
                                }>
                                  <h2
                              ...
                              <div
                                ...
                                <Link
                                  href={`/analysis/education/subcoin-mix/${item.slug}`}
...
export async function getServerSideProps(context) {
  ...
  const {data} = await axios.get(
    `/api/posts?homeCategory=education&category=subcoin-mix&limit=16&page=1`,
    {
      headers: {
        cookie: cookie,
      },
