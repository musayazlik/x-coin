                          ...
                          >
                            ...
                            <CardBody
                              ...
                              <div className="flex flex-col">
                                ...
                                <Link href={
                                  `/analysis/education/sub-indices/${item.slug}`
                                }>
                                  <h2
                              ...
                              <div
                                ...
                                <Link
                                  href={`/analysis/education/sub-indices/${item.slug}`}
...
export async function getServerSideProps(context) {
  ...
  const {data} = await axios.get(
    `/api/posts?homeCategory=education&category=sub-indices&limit=16&page=1`,
    {
      headers: {
        cookie: cookie,
      },
