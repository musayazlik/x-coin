...
const Login = () => {
  ...
  return (
    <>
      ...
      <Head>
        <title>Trader Edit | {t.registerPage.title}</title>
        <meta name="description" content={t.registerPage.description}/>
        <meta name="keywords" content={t.registerPage.keywords}/>
