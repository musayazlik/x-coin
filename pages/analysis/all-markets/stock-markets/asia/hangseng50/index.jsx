                        ...
                        <Card className={`py-2 relative z-0 h-full `}>
                          ...
                          <CardBody
                            ...
                            <div className="flex flex-col">
                              ...
                              <Link
                                href={`/analysis/all-markets/stock-markets/asia/hangseng50/${item.slug}`}
                              >
                                <h2
...
export default Hangseng50;

export async function getServerSideProps(context) {
  const cookie = context.req.headers.cookie;
  const {data} = await axios.get(`/api/posts?category=hangseng50&limit=16&page=1`, {
    headers: {
      cookie: cookie,
    },
  });
