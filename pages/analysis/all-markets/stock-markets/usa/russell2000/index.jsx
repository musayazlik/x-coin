                        ...
                        <Card className={`py-2 relative z-0 h-full `}>
                          ...
                          <CardBody
                            ...
                            <div className="flex flex-col">
                              ...
                              <Link
                                href={`/analysis/all-markets/stock-markets/usa/russell2000/${item.slug}`}
                              >
                                <h2
...
export async function getServerSideProps(context) {
  ...
  const {data} = await axios.get(`/api/posts?category=russell2000&limit=16&page=1`, {
    headers: {
      cookie: cookie,
    },
  });
